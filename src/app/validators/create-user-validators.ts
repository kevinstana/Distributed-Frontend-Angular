...
export const createUserFormValidators = {
    ...
    verifyPasswordValidators: [Validators.required, Validators.minLength(8), Validators.maxLength(120)],
...
export const createUserForm = new FormGroup({
    username: new FormControl<string | null | undefined>('', createUserFormValidators.usernameValidators),
    password: new FormControl<string | null | undefined>('', createUserFormValidators.passwordValidators),
    verifyPassword: new FormControl<string | null | undefined>('', createUserFormValidators.verifyPasswordValidators),
    email: new FormControl<string | null | undefined>('', createUserFormValidators.emailValidators),
    ...
    firstName: new FormControl<string | null | undefined>('', createUserFormValidators.firstNameValidators),
    lastName: new FormControl<string | null | undefined>('', createUserFormValidators.lastNameValidators),
    afm: new FormControl<string | null | undefined>('', createUserFormValidators.afmValidators),
    amka: new FormControl<string | null | undefined>('', createUserFormValidators.amkaValidators)
